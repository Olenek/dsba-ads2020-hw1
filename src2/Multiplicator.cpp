...
{
    std::vector<short> result(n1.size() + n2.size(), 0);
...
double Multiplicator::measure_time(const std::function<Number(Number, Number)>& f, const Number &n1, const Number &n2)
{
